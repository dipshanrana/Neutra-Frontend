...
export function BlogDetailClient({ initialArticle, initialRelated }: { initialArticle: Blog, initialRelated: Blog[] }) {
    const [article, setArticle] = useState<Blog>(initialArticle);
    const [related, setRelated] = useState<Blog[]>(initialRelated);
