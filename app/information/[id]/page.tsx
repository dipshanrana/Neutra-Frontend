        ...
        return (
            <main className="min-h-screen bg-[#FBFBFA] flex flex-col font-sans">
                ...
                <div className="flex-1 flex flex-col items-center justify-center py-40 text-center px-4 bg-[#0A190E]">
                    <Binary className="w-16 h-16 text-emerald-500/30 mb-8 blur-[1px]" />
                    <h1 className="text-4xl md:text-5xl font-heading text-white font-medium mb-6 tracking-tight">Report Unavailable</h1>
                    <p className="text-emerald-500/60 mb-10 max-w-md font-mono text-sm tracking-widest uppercase">ERR_MODULE_NOT_FOUND</p>
                    <Link href="/information" className="px-10 py-4 bg-emerald-600/10 text-emerald-500 border border-emerald-500/30 rounded-full font-black uppercase tracking-[0.2em] text-[10px] hover:bg-emerald-600 hover:text-[#0A190E] transition-all">
                        Initialize Return
                    </Link>
                </div>
                <Footer />
        ...
        <main className="min-h-screen bg-[#FBFBFA] selection:bg-emerald-600 selection:text-white flex flex-col font-sans">
            ...
            <div className="bg-[#0A190E] border-b border-[#1A2E20] sticky top-0 z-40">
                <div className="max-w-screen-2xl mx-auto px-6 h-14 flex items-center justify-between">
                    <Link href="/information" className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.3em] text-emerald-500/60 hover:text-emerald-400 transition-colors">
                ...
                <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-16 border-t border-[#1A2E20] pt-10">
                        <div className="flex flex-col items-center">
                            ...
                            <span className="text-emerald-500 font-bold tracking-widest">MOD-{info.id?.toString().padStart(3, '0') || 'ARCH'}</span>
                        </div>
                        <div className="flex flex-col items-center">
                            <span className="text-[9px] font-mono text-stone-500 uppercase tracking-widest mb-2">Category</span>
                            <span className="text-emerald-500 font-bold uppercase tracking-widest">{catName}</span>
                        </div>
                        <div className="flex flex-col items-center">
                            <span className="text-[9px] font-mono text-stone-500 uppercase tracking-widest mb-2">Data Integrity</span>
                            <span className="text-emerald-500 font-bold uppercase tracking-widest flex items-center gap-1">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-12 lg:gap-20">
                            ...
                            <div className="bg-white rounded-[3rem] p-10 lg:p-16 border border-stone-100 shadow-sm">
                                ...
                                <div
                                    className="prose prose-lg prose-stone max-w-none
                                        prose-headings:font-heading prose-headings:font-medium prose-headings:tracking-tight prose-headings:text-[#1D3557] prose-headings:mb-6
                                        ...
                                        prose-li:before:content-[''] prose-li:before:block prose-li:before:w-1.5 prose-li:before:h-1.5 prose-li:before:rounded-full prose-li:before:bg-emerald-500 prose-li:before:mt-2.5"
                        ...
                        <div className="space-y-8 lg:mt-32">
                            ...
                            <div className="bg-[#0A190E] rounded-[2.5rem] p-10 text-white relative overflow-hidden group">
                                ...
                                <Activity className="w-8 h-8 text-emerald-500 mb-8" />
                                <h4 className="text-2xl font-heading font-medium tracking-tight mb-4">Module Status</h4>
                                <ul className="space-y-6">
                                    <li className="flex flex-col">
                                        <span className="text-[9px] font-mono text-emerald-500/60 uppercase tracking-widest mb-1">Clearance</span>
                                        <span className="font-bold text-sm tracking-wide">Public Read-Only</span>
                                    </li>
                                    <li className="flex flex-col">
                                        <span className="text-[9px] font-mono text-emerald-500/60 uppercase tracking-widest mb-1">Last Sync</span>
                                        <span className="font-bold text-sm tracking-wide">Current Cycle</span>
                                    </li>
                                    <li className="flex flex-col">
                                        <span className="text-[9px] font-mono text-emerald-500/60 uppercase tracking-widest mb-1">Encryption</span>
                            ...
                            <div className="bg-white rounded-[2.5rem] p-10 border border-stone-200 shadow-sm text-center">
                                ...
                                <h4 className="text-xl font-heading font-medium text-[#1D3557] mb-2">Export Data</h4>
                                <p className="text-stone-400 text-sm mb-8">Download PDF synthesis of this exact product module.</p>
                                <button className="w-full py-4 bg-stone-100 hover:bg-emerald-600 hover:text-white text-stone-600 rounded-full text-[10px] font-black uppercase tracking-[0.2em] transition-colors flex items-center justify-center gap-3">
