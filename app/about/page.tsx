    ...
    return (
        <main className="min-h-screen bg-[#FFFCF2] selection:bg-[#D4AF37] selection:text-white flex flex-col font-sans">
            ...
            <section className="pt-32 pb-24 bg-white relative overflow-hidden flex-1">
                ...
                <div className="absolute bottom-[-10%] right-[-10%] w-[600px] h-[600px] rounded-full bg-[#D4AF37]/5 blur-[120px] pointer-events-none"></div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-24 max-w-4xl mx-auto mt-12">
                        ...
                        <p className="text-[#252422]/60 font-sans text-xl font-light leading-relaxed mb-12">
                    ...
                    <div className="bg-[#D4AF37] rounded-[3rem] p-12 lg:p-24 text-center text-white relative overflow-hidden shadow-2xl">
                        ...
                        <button className="relative z-10 px-10 py-5 bg-[#D4AF37] text-white rounded-full font-bold uppercase tracking-widest text-xs hover:bg-white hover:text-[#252422] hover:shadow-[0_0_30px_rgba(52,160,164,0.4)] transition-all duration-300">
                            Explore the Catalog
                        </button>
                    </div>
